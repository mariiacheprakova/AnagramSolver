...
SELECT Words.CategoryId AS CategoryName, Words.Value, Words.CreatedAt
FROM Words
INNER JOIN Categories ON Words.CategoryId = Categories.Id;
...
SELECT SearchText, ResultCount, SearchedAt
FROM SearchLog
GROUP BY ResultCount
